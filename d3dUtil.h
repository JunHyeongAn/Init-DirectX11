...
// D3DX11_FILTER_* 는 D3DX에만 있던 플래그. 이 코드에선 값 비교/전달 수준이면 0으로 둬도 무방.
#ifndef D3DX11_FILTER_NONE
#define D3DX11_FILTER_NONE 0u
#endif
#ifndef D3DX11_FILTER_LINEAR
#define D3DX11_FILTER_LINEAR 0x1u
#endif

// DXGI_FORMAT_FROM_FILE 은 표준이 아님. "파일에서 추론" 의미였을 가능성 → UNKNOWN 으로 두고 로더가 판단하게.
#ifndef DXGI_FORMAT_FROM_FILE
#define DXGI_FORMAT_FROM_FILE DXGI_FORMAT_UNKNOWN
#endif
